...
public class QQMusicInfo extends AbstractMusic {
     ...
     */
    @MusicService(url = "/song/urls", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/song/url", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/search", serviceProvider = MusicEnum.QQMusic)
     ...
     * 返回示例：k 为热搜词，n 为搜索量
     */
    @MusicService(url = "/search/hot", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/song/find", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/song/finds", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/user/cookie", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/user/detail", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/user/songlist", serviceProvider = MusicEnum.QQMusic)
     ...
     * pageSize: 默认 20
     */
    @MusicService(url = "/user/collect/songlist", serviceProvider = MusicEnum.QQMusic)
     ...
     * pageSize: 默认 20
     */
    @MusicService(url = "/user/collect/album", serviceProvider = MusicEnum.QQMusic)
     ...
     * }
     */
    @MusicService(url = "/songlist", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/songlist/category", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/songlist/list", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/songlist/map", serviceProvider = MusicEnum.QQMusic)
     ...
     * dirid: 必填
     */
    @MusicService(url = "/songlist/add", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/songlist/remove", serviceProvider = MusicEnum.QQMusic)
     ...
     * 如果歌单名重复，也会报错
     */
    @MusicService(url = "/songlist/create", serviceProvider = MusicEnum.QQMusic)
     ...
     * dirid: 必填
     */
    @MusicService(url = "/songlist/delete", serviceProvider = MusicEnum.QQMusic)
     ...
     * op: 必填 1 收藏；2 取消收藏
     */
    @MusicService(url = "/songlist/collect", serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/song", serviceProvider = MusicEnum.QQMusic)
     ...
     * 这个接口本质为上一个接口的批量调用
     */
    @MusicService(url = "/song/batch", serviceProvider = MusicEnum.QQMusic)
     ...
     * 返回相似歌曲列表
     */
    @MusicService(url = "/song/similar", serviceProvider = MusicEnum.QQMusic)
     ...
     * 返回相关歌单列表
     */
    @MusicService(url = "/song/playlist",serviceProvider = MusicEnum.QQMusic)
     ...
     * 返回相关mv列表
     */
    @MusicService(url = "/song/mv",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/lyric",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/recommend/playlist/u",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/recommend/playlist",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/recommend/daily",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/recommend/banner",serviceProvider = MusicEnum.QQMusic)
     ...
     * 这里和官方接口的参数是一致的
     */
    @MusicService(url = "/new/album",serviceProvider = MusicEnum.QQMusic)
     ...
     * 获取歌手的一些详细信息介绍
     */
    @MusicService(url = "/singer/desc",serviceProvider = MusicEnum.QQMusic)
     ...
     * page: 页数 默认为第一页
     */
    @MusicService(url = "/singer/songs",serviceProvider = MusicEnum.QQMusic)
     ...
     * pageSize: 默认 20
     */
    @MusicService(url = "/singer/mv",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/singer/category",serviceProvider = MusicEnum.QQMusic)
     ...
     * 示例：
     */
    @MusicService(url = "/singer/list",serviceProvider = MusicEnum.QQMusic)
     ...
     * albummid: 必填
     */
    @MusicService(url = "/album",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/comment",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/comment/send",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/comment/del",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/comment/like",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/mv/url",serviceProvider = MusicEnum.QQMusic)
     ...
     * 和获取歌手分类接口类似
     */
    @MusicService(url = "/mv/category",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/mv/list",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/top/category",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/top",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/user/follow/singers",serviceProvider = MusicEnum.QQMusic)
     ...
     * id: 用户的 qq 号，默认为当前登陆用户
     */
    @MusicService(url = "/user/follow/users",serviceProvider = MusicEnum.QQMusic)
     ...
     * id: 用户的 qq 号，默认为当前登陆用户
     */
    @MusicService(url = "/user/fans",serviceProvider = MusicEnum.QQMusic)
     ...
     */
    @MusicService(url = "/user/follow",serviceProvider = MusicEnum.QQMusic)
     ...
     * 这个接口会返回各个数据的统计结果
     */
    @MusicService(url = "/data",serviceProvider = MusicEnum.QQMusic)
